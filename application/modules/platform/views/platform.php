      ...
      <div class="container">
		...
		<div class="mb-4">
			...
			<div class="form-check">
				<input name="platform" class="form-check-input" type="checkbox" value="facebook" id="flexCheckDefault">
				<label for="platform" class="form-check-label" for="flexCheckDefault">
				Facebook
				</label>
			</div>
			<div class="form-check">
				<input name="platform" class="form-check-input" type="checkbox" value="instagram" id="flexCheckChecked">
				<label for="platform" class="form-check-label" for="flexCheckChecked">
				Instagram
				</label>
			</div>
			<div class="form-check">
			<input name="platform" class="form-check-input" type="checkbox" value="youtube" id="flexCheckChecked">
				<label for="platform" class="form-check-label" for="flexCheckChecked">
				YouTube
				</label>
			</div>
			<div class="form-check">
				<input name="platform" class="form-check-input" type="checkbox" value="twitter" id="flexCheckChecked">
				<label for="platform" class="form-check-label" for="flexCheckChecked">
				Twitter
				</label>
			</div>
			<div class="form-check">
				<input name="platform" class="form-check-input" type="checkbox" value="tik tok" id="flexCheckChecked">
				<label for="platform" class="form-check-label" for="flexCheckChecked">
				Tik Tok
				</label>
			</div>
			<div class="form-check">
				<input name="platform" class="form-check-input" type="checkbox" value="wechat" id="flexCheckChecked">
				<label for="platform" class="form-check-label" for="flexCheckChecked">
				WeChat
				</label>
			</div>
		...
		<div class="mb-4">
			<label for="postingan_ada" class="form-label">Apakah postingan ataupun komentar yang mengandung cyberbullying tersebut masih ada?</label>
			<div class="form-check">
